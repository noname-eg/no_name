...
export default function Admin() {
  ...
  const editProduct = (product: StoreProduct) => { setForm({ ...product, colors: product.colors?.length ? product.colors : ["#222222"], sizes: product.sizes || [] }); setEditing(true); setActiveTab("products"); window.scrollTo(0, 0); };
