...
export function StoreLayout({ children }: { children: ReactNode }) {
  ...
  const [siteSettings, setSiteSettings] = useState<SiteSettings>(() => { const defaults: SiteSettings = { announcement: "Free shipping on orders over 2,500 EGP · Cash on delivery available", accent: "#d4775c", heroTitle: "New for Summer 2026", heroDescription: "Modest styles designed for everyday comfort.", socialLinks: { instagram: "", facebook: "", youtube: "", whatsapp: "https://wa.me/201553003040", tiktok: "" } }; try { const saved = JSON.parse(localStorage.getItem("no-name-settings") || "null") as SiteSettings | null; return { ...defaults, ...saved, socialLinks: { ...defaults.socialLinks, ...saved?.socialLinks } }; } catch { return defaults; } });
